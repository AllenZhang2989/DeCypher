...
image = cv2.imread(r"C:\Users\Adam\Desktop\Newhacks2020\Image OCR\ImageOCR\ImageOCR\picture.JPG")
...
for i in range(0,count):
   def white_bg_square(img):
        ...
        return layer
   img = Image.open(r"C:\Users\Adam\Desktop\Newhacks2020\Image OCR\ImageOCR\ImageOCR\char"+str(i)+".png")
   w, h = img.size
   if w>100 and h > 100:
       dim = (80,80)
       img = cv2.resize(img, dim, interpolation= cv2.INTER_AREA)
   img = white_bg_square(img)
   img.save(r"C:\Users\Adam\Desktop\Newhacks2020\Image OCR\ImageOCR\ImageOCR\char"+str(i)+".png")
